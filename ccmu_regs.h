...
typedef struct __CCMU_SYSCLK_RATIO_REG0054
{
    ...
    __u32   CPUClkSrc: 2;       //bit16, CPU clock source select, 00-internal LOSC, 01-HOSC, 10-PLL1, 11-200MHz
...
typedef struct __CCMU_AHBCLK_GATE0_REG0060
{
    ...
    __u32   reserved5:3;        //bit27, reserved
...
typedef struct __CCMU_REG_LIST
{
    ...
    volatile __ccmu_module1_clk_t           I2s0Clk;     //0x00B8, IIS module clock control
